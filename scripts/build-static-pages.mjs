  ...
  <head>
    ...
    <style>
      ...
      * { box-sizing: border-box; }
      ...
      .hicp-summary-wrap { overflow-x:auto; }
      .hicp-summary table { min-width:920px; font-size:.88rem; }
      .hicp-summary th,.hicp-summary td { text-align:right; }
      .hicp-summary th:first-child,.hicp-summary td:first-child { width:30%; text-align:left; }
