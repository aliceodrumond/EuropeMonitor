  ...
  <body>
    ...
    <script>
      const charts = [
        ...
        ["bls_credit_standards","activity","Tight credit standards","ECB Lending Survey","GDP q/q","Net %",false,["gdp_qoq_sa_bls_standards","bls_standards_corporate_ea","bls_standards_consumer_ea"],{left:{min:-3,max:3},right:{min:-20,max:30}},"all"],
        ["bls_loan_demand","activity","... and weak demand","ECB Lending Survey","GDP q/q","Net %",false,["gdp_qoq_sa_bls_demand","bls_demand_consumer_ea","bls_demand_corporate_ea"],{left:{min:-3,max:3},right:{min:-50,max:50}},"all"],
