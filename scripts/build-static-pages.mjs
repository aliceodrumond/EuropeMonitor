  ...
  <body>
    ...
    <script>
      const charts = [
        ...
        ["hicp_headline_rates","inflation","HICP Headline","Inflation","%",null,false,["hicp_headline_yoy_nsa","hicp_headline_qoq_saar","hicp_headline_mom_saar"],null,"10y"],
        ["hicp_core_rates","inflation","HICP Core","Inflation","%",null,false,["hicp_core_yoy_nsa","hicp_core_qoq_saar","hicp_core_mom_saar"],null,"10y"],
        ["hicp_goods_rates","inflation","HICP Goods","Inflation","%",null,false,["hicp_goods_yoy_nsa","hicp_goods_qoq_saar","hicp_goods_mom_saar"],null,"10y"],
        ["hicp_services_rates","inflation","HICP Services","Inflation","%",null,false,["hicp_services_yoy_nsa","hicp_services_qoq_saar","hicp_services_mom_saar"],null,"10y"],
