  ...
  <body>
    ...
    <script>
      const charts = [
        ...
        ["hicp_headline_rates","inflation","HICP Headline","Inflation","%",null,false,["hicp_headline_yoy_nsa","hicp_headline_hoh_saar","hicp_headline_qoq_saar","hicp_headline_mom_saar"],{left:{min:-2,max:12}},"10y","2018-01-01"],
        ["hicp_core_rates","inflation","HICP Core ex-Energy, Food, Alcohol and Tobacco","Inflation","%",null,false,["hicp_core_yoy_nsa","hicp_core_hoh_saar","hicp_core_qoq_saar","hicp_core_mom_saar"],{left:{min:-2,max:8}},"10y","2018-01-01"],
        ["hicp_goods_rates","inflation","HICP Non-Energy Industrial Goods","Inflation","%",null,false,["hicp_goods_yoy_nsa","hicp_goods_hoh_saar","hicp_goods_qoq_saar","hicp_goods_mom_saar"],{left:{min:-3,max:8}},"10y","2018-01-01"],
        ["hicp_services_rates","inflation","HICP Services","Inflation","%",null,false,["hicp_services_yoy_nsa","hicp_services_hoh_saar","hicp_services_qoq_saar","hicp_services_mom_saar"],{left:{min:-1,max:9}},"10y","2018-01-01"],
      ...
      ].map(([id,tab,title,kicker,yLeft,yRight,wide,order,fixedDomains,defaultWindow,startDate]) => ({id,tab,title,kicker,yLeft,yRight,wide,order,fixedDomains,defaultWindow,startDate}));
      ...
      function styleForSeries(id, fallback){ if(id.endsWith("_yoy_nsa")) return {color:"#111111"}; if(id.endsWith("_qoq_saar")) return {color:"#a83f39"}; if(id.endsWith("_hoh_saar")) return {color:"#11675f"}; if(id.endsWith("_mom_saar")) return {color:"#65b88f",dashArray:"6 5"}; return {color:fallback}; }
