...
function Test-OutputData {
  ...
  foreach ($series in @(
    ...
    "hicp_services_ex_volatiles_yoy_nsa",
    "hicp_services_ex_volatiles_qoq_saar",
    "hicp_services_ex_volatiles_mom_saar",
    "hicp_services_ex_volatiles_mom_nsa_median",
    "hicp_services_ex_volatiles_mom_nsa_2026",
    "hicp_energy_intensive_yoy_nsa",
    "hicp_energy_intensive_qoq_saar",
    "hicp_energy_intensive_mom_saar",
    "hicp_energy_intensive_mom_nsa_median",
    "hicp_energy_intensive_mom_nsa_2026",
    "hicp_wage_intensive_yoy_nsa",
    "hicp_wage_intensive_qoq_saar",
    "hicp_wage_intensive_mom_saar",
